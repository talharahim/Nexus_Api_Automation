...
Write-Host "Running RemoveCsmApiContentFromCompanyDB.sql...."
Invoke-sqlcmd -inputfile "RemoveCsmApiContentFromCompanyDB.sql" -serverinstance $SQLServerInstance -database $SQLCompanyDB 
...
Invoke-sqlcmd -inputfile "Search_Install_Api_DatabaseComponents_v2.0.0.sql" -serverinstance $SQLServerInstance -database $SQLApiDB
Write-Host "....DONE"

#Read-Host -Prompt "Does that look right? Press <ENTER> to continue or CTRL+C to quit" 
Write-Host "Running search to install into CSM Database...."
Invoke-sqlcmd -inputfile "Search_Install_CSM_DatabaseComponents_v2.0.0.sql" -serverinstance $SQLServerInstance -database $SQLCompanyDB
Write-Host "....DONE"
#Read-Host -Prompt "Does that look right? Press <ENTER> to continue or CTRL+C to quit"
